---
title: "MSEP Water Quality Working Group survey responses: Summary of goals and interests"
format: 
    revealjs: default
    html:
        toc: true
...
in_file <- here::here("input",
                      "2026-04-17 MSEP WQ Working Group Interest (Responses).xlsx")
...
## Role: How many boxes did each person check?  
...
## Techniques: How many boxes did each person check?  
...
## Techniques: What were the selections? 
...
## Topics: How many boxes did each person check?  
...
## Topics: What were the selections?  
